...
module.exports = function (options) {
    ...
    function _fnPutAsideIn(requestPart) {
         ...
         * @private
         * @param {object} req
         * @param {object} [req[requestPart]]
         * @param {object} [req[polluted]]
         */
        return function _putAside(req) {
    ...
    var _putAsideInQuery = _fnPutAsideIn('query');
    var _putAsideInBody = _fnPutAsideIn('body');
